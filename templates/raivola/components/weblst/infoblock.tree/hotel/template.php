						...
						<div class="item tabletatle">
							<div class="name flex flex-just_space">
								...
								<div class="price">
									...
									<span class='st'>Проживание<br> (пн - вс)</span> <span  class='st'><br></span> 
								</div>
							</div>
							<div class="desc">
								<?=$item['PREVIEW_TEXT']?>
						...
						<div class="item">
							<div class="name flex flex-just_space">
								...
								<div class="price">
									...
									<span class='count st'>	<?= number_format($item['PROPERTY_PRICE_VALUE'], 0, '', ' '); ?> р</span> <span class='st'><?//= number_format($item['PROPERTY_PRICE2_VALUE'], 0, '', ' '); ?></span> 
								</div>
							</div>
							<div class="desc">
								<?=$item['PREVIEW_TEXT']?>
