						...
						<div class="item tabletatle">
							<div class="name flex flex-just_space">
								...
								<div class="price">
									...
									<span class='st'>Вес</span> <span  class='st'>Цена</span> <span  class='st'>Цена по карте*</span>
								</div>
							</div>
							<div class="desc">
								<?=$item['PREVIEW_TEXT']?>
						...
						<div class="item">
							<div class="name flex flex-just_space">
								...
								<div class="price">
								 ...
								 <?if($item['PROPERTY_COUNT_VALUE']):?><span class='count st'>	<?=$item['PROPERTY_COUNT_VALUE']?></span><?endif?> <span class='st'><?= number_format($item['PROPERTY_PRICE_VALUE'], 0, '', ' '); ?> р</span> <span class='st'><?=number_format($item['PROPERTY_PRICE2_VALUE'], 0, '', ' ');?> р</span>
								</div>
							</div>
							<div class="desc">
								<?=$item['PREVIEW_TEXT']?>
